...
1. Render a container area boundary for sticky notes
2. Display a fixed add button at right bottom corner of the screen which will add a new note when clicked.
